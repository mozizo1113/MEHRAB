...
import { AppMode, AttachedImage, ChatMessage, UserProfile } from './types';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-row w-full max-w-[1600px] mx-auto overflow-hidden">
        {/* Persistent Desktop Sidebar (hidden completely when reading mode is active) */}
        {!isReadingMode && (
          <Sidebar
            messages={history}
        ...
        {/* Main Content Area - Expands when reading mode is active */}
        <main
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            {isLoading && (
              <div className="max-w-sm sm:max-w-md mx-auto my-4 sm:my-8 p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-[#f5efe3] dark:bg-[#182723] border border-[#e4d9c6] dark:border-[#273d36] text-center shadow-sm animate-pulse">
                ...
                <p className="text-[11px] sm:text-xs text-[#5e7169] dark:text-[#8ea59d] font-alexandria">
